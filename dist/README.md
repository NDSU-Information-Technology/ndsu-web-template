# NDSU Template Quick User Guide
...
#### Desktop Navigation
Visit the [`navbar` component](/src/components/navbar/) for more information on how to use the `navbar` component as desktop navigation.
