...
var myCarousel = (function() {
  ...
  function init(set) {
    ...
    ctrls.innerHTML = '<li>' +
    '<button type="button" class="btn-prev"><span class="sr-only">Previous Slide</span>&lsaquo;</button>' +
    '</li>' +
    '<li>' +
    '<button type="button" class="btn-next"><span class="sr-only">Next Slide</span>&rsaquo;</button>' +
    '</li>';
